...
frequency_table = build_frequency_table(prepare_text('do you see what i see'))
#print (build_frequency_table(prepare_text("ABC def ghi!  what. here? me me moi")))
...
#table1 = build_frequency_table(prepare_text('do you see what i see'))
#table2 = build_frequency_table(prepare_text("ABC def ghi!  what. here? me me moi"))
#print(frequency_comparison(table1,table2))
table1 = build_frequency_table(prepare_text(murder_note))
table2 = build_frequency_table(prepare_text(lily_trebuchet_intro))
print(" FREQ: ",frequency_comparison(table1,table2))
m1 = frequency_comparison(table1,table2)
print("M1 :",m1)
